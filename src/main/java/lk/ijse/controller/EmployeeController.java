    ...
    public void loadvalues() throws SQLException {
        try {
            ...
            for (EmployeeModel employeeModel : employeeModels) {
                ...
                employeeTable.getItems().add(new EmployeeTM(employeeModel.getE_ID(), employeeModel.getNIC(), employeeModel.getFirst_Name(), employeeModel.getLast_Name(), employeeModel.getAddress(), mobile, employeeModel.getEmail(), employeeModel.getSalary(), employeeModel.getPosition(), new JFXButton("delete"), new JFXButton("update")));
